...
const BalanceReport = () => {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/allBankData")
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleExport = () => {
    ...
    const banks = [
      ...
      { name: "Dhaka Bank Ltd (OD)", key: "DhakaBankLtdOD" },
            ...
            <table className="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border px-2 py-1">Dhaka Bank Ltd (OD)</td>
                  {filteredData.map((item, index) => (
                    <td key={index} className="border px-2 py-1 text-right">
                      {item.DhakaBankLtdOD?.toString().replace(
                        /\B(?=(\d{3})+(?!\d))/g,
                        ","
                      )}
                    </td>
